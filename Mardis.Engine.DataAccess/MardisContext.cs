...
namespace Mardis.Engine.DataAccess
{
    public class MardisContext : DbContext
    {
        ...
        /// <summary>
        /// Tabla de Codigo Automaticos _FormTable
        /// </summary>
        public DbSet<_FormTable> _FormTables { get; set; }
        ...
        /// <summary>
        /// Tabla de Modelo de preguntas Dinamicas
        /// </summary>
        public DbSet<AnswerDetailSecondLevel> AnswerDetailSecondLevels { get; set; }
